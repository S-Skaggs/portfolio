  ...
  template: `
    ...
    <div class="grid">
      ...
      <section>
        ...
        <p>After successfully graduating from NPTU in 1992, I was transferred to the <a href="https://www.history.navy.mil/research/histories/ship-histories/danfs/v/virginia-v.html" target="_blank">USS Virginia (CGN-38)</a>, a <a href="https://naval-encyclopedia.com/cold-war/us/virginia-class-cruisers.php" target="_blank">Virginia class</a> nuclear-powered cruiser stationed in Norfolk, Virginia. To date, all of these great
        ships have been decommissioned. In fact, I was on the decommissioning crew of the Virginia at that time.</p>
